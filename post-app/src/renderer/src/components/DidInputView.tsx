    ...
    <div class="flex items-center justify-center min-h-screen p-4">
      <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div class="mb-4">
            <p class="block text-sm font-medium text-gray-700 mb-2">Account Mode</p>
            <div class="flex gap-4 mb-4">
              <label class="flex items-center cursor-pointer">
                <input
                  ...
                  class="mr-2"
                />
                <span class="text-sm text-gray-700">Sign in with existing account</span>
              </label>
              <label class="flex items-center cursor-pointer">
                <input
                  type="radio"
          ...
          {mode() === 'existing' ? (
            <>
              <div class="mb-4">
                <label for="didWeb" class="block text-sm font-medium text-gray-700 mb-2">
                  DID Web
                </label>
                <input
                  id="didWeb"
              ...
              <div class="mb-4">
                <label for="privateKey" class="block text-sm font-medium text-gray-700 mb-2">
                  Private Key (hex)
                </label>
                <input
                  id="privateKey"
