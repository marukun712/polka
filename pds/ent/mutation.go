...
func (m *RecordMutation) SetContent(s string) {
	m.content = &s
}

// Content returns the value of the "content" field in the mutation.
func (m *RecordMutation) Content() (r string, exists bool) {
	v := m.content
	if v == nil {
		return
	}
...
// OldContent returns the old "content" field's value of the Record entity.
// If the Record object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RecordMutation) OldContent(ctx context.Context) (v string, err error) {
...
func (m *RecordMutation) ResetContent() {
	m.content = nil
}

// SetSig sets the "sig" field.
func (m *RecordMutation) SetSig(s string) {
	m.sig = &s
}

// Sig returns the value of the "sig" field in the mutation.
func (m *RecordMutation) Sig() (r string, exists bool) {
	v := m.sig
	if v == nil {
		return
	}
...
// OldSig returns the old "sig" field's value of the Record entity.
// If the Record object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RecordMutation) OldSig(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RecordMutation) ResetSig() {
	m.sig = nil
}

// SetPk sets the "pk" field.
func (m *RecordMutation) SetPk(s string) {
	m.pk = &s
}

// Pk returns the value of the "pk" field in the mutation.
func (m *RecordMutation) Pk() (r string, exists bool) {
	v := m.pk
	if v == nil {
		return
	}
...
// OldPk returns the old "pk" field's value of the Record entity.
// If the Record object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RecordMutation) OldPk(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RecordMutation) Fields() []string {
	...
	if m.content != nil {
		fields = append(fields, record.FieldContent)
	}
	if m.sig != nil {
		fields = append(fields, record.FieldSig)
	}
	if m.pk != nil {
		fields = append(fields, record.FieldPk)
	}
	return fields
}
